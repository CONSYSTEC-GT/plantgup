  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        contenidoArchivo: base64Content.split(',')[1], // Solo el contenido Base64 sin el prefijo
      };
  
      // Mostrar el request armado en la consola
      console.log('HEADER', {
      ...
      const response = await fetch('https://dev.talkme.pro/WsFTP/api/ftp/upload', {
        ...
        body: JSON.stringify(payload), // Asegúrate de que el body sea un JSON string
      });
