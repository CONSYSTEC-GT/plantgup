...
const PreviewWhatsAppStyle = ({ templateName, categories, selectedCategory }) => {
  ...
  return (
    ...
    >
      ...
      <Box
        sx={{
          bgcolor: '#e1ffc7', // Verde claro como los mensajes enviados en WhatsApp
          p: 2,
          borderRadius: 2,
          alignSelf: 'flex-end',
          maxWidth: '70%',
      ...
      <Box
        sx={{
          bgcolor: '#fff', // Blanco como los mensajes recibidos en WhatsApp
          p: 2,
          borderRadius: 2,
      ...
      >
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 1 }}>
          ...
          <Typography variant="body1">
            {categories.find(cat => cat.id === selectedCategory)?.title || 'No category selected'}
          </Typography>
        </Box>
      </Box>
